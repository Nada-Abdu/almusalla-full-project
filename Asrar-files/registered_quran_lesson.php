...
$query="SELECT 
RegisteredLesson.Student_ID, RegisteredLesson.Activity_ID,   facultymember.FacultyUniversityID, facultymember.FacultyMemberName, QuranVolunteer.Quran_volunteer_id,QuranVolunteer.Surah_name 
FROM RegisteredLesson
