...
if (mysqli_num_rows($result) > 0) {
    ...
    if ($activitytype ==  "نشاط حلقات القران الكريم"){
      ...
      $surah = $activityname;
      $appointment = "سيتم اختيار الموعد المناسب بعد التسجيل من صفحة الدروس المسجلة";
    }
    if ($activitytype ==  "نشاط الدروس الإسلامية"){
      $activity = $activityname ;
      $surah = "";
      $sq = "SELECT IslamicVolunteerID, lessonName ,meetingsNumber , Day, LessonDate,time FROM  islamicvolunteer WHERE lessonName = '$activity' ";
      ...
      $Lessontime = $ro["time"];
      $meetingNumbers = $ro["meetingsNumber"];
...
<li><a style="font-size:15px;">|</a></li>
  ...
  <div class="slider_area" style= "padding-left:1%">
    <div class="single_slider  d-flex align-items-center   " style="  background-image: url( activity/activity.jpeg);   background-size:auto;   background-position:top ;">
      ...
      <div class="row text-right" style="margin-left:67%; margin-top:-24%;">
...
window.setTimeout(function() {
        location.replace("course Activities.php");
        }, 2000);
  }
  </script>
...
$sql1 = "INSERT INTO  registeredactivity (Student_ID, activityid)
