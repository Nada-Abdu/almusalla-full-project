...
<body>
  ...
  <?php 
  $ACT_id= $_GET['act_id'];
  $sql2 = "SELECT * FROM activities  WHERE activityid= $ACT_id";
  ...
  ?>
<div style="  margin-top:-29%;padding:5%" >
          ...
          <div class="row justify-content-center">
              <div class="col-lg-12">
                  <form action="#" class="donation_form">
                          ...
                          <div style="  text-align: right;  margin-top:-10% ; padding-right:-33.9%" >
                              <div class="single_amount">
                                 <div class="fixed_donat">
                                   <div class="row">
                                        <div class="col-3">
                                       <h4 dir="rtl" > نوع النشاط :<label dir="rtl" style="width:50%; padding-right:1.2% "  > <?php echo $row['activitytype'];?> </label></h4>
                                           </div>
                                           <div class="col-3">
                                           <h4 dir="rtl" > رقم الشعبـــــة :   <label dir="rtl"  style="width:40%;padding-right:1.2% "  > <?php echo $row['groupnum'];?>  </label></h4>
                                            </div>
                                              <div class="col-3">
                                             <h4 dir="rtl"  >   رقم المقــــرر :   <label dir="rtl" style="width:40%; padding-right:1.2%" >  <?php echo $row['courseid'];?>   </label></h4>
                                                 </div>
                                           <div class="col-3">
                                            <h4 dir="rtl"> اسـم المقـــــرر :   <label dir="rtl" style="width:40%;padding-right:1.2%" > <?php echo $row['coursename'];?>  </label></h4>
                                                  </div>
                                              </div> 
...
$LessonID=0;
$s =0;
$sql4 =  "SELECT  student_ID ,IslamicVolunteerID FROM attendance where activityid='$Activity_ID' GROUP BY student_ID  ";
...
$worthing =0;
$sql1 = "SELECT * FROM worthingcertificate WHERE Student_ID=$student[$x] AND IslamicVolunteerID = $LessonID";
if ($result1 = $connect-> query($sql1)) {
    if(mysqli_num_rows($result1)>0){
    $worthing =1;
}}

$sql = "SELECT * FROM attendance WHERE student_ID=$student[$x] AND IslamicVolunteerID = $LessonID ";
...
while ($row = mysqli_fetch_array($result, MYSQLI_NUM)) {
  ...
  ?>
    ...
    <tr>
      <td> <?php echo $name; ?> </td>
      <td> <?php if($meeting_state[0]==1 && $meeting[0]==1 ){ echo "&#10004";}  ?> </td>
      <td> <?php if($meeting_state[1]==1 && $meeting[1]==2 ){ echo "&#10004";}  ?> </td>
      <td> <?php if($meeting_state[2]==1 && $meeting[2]==3){ echo "&#10004";}  ?> </td>
      <td> <?php if($meeting_state[3]==1 && $meeting[3]==4){ echo "&#10004";}  ?> </td>
      <td> <?php if($meeting_state[4]==1 && $meeting[4]==5){ echo "&#10004";}  ?> </td>
      <td> <?php if($meeting_state[5]==1 && $meeting[5]==6){ echo "&#10004";}  ?> </td>
      <td> <?php if($meeting_state[6]==1 && $meeting[6]==7){ echo "&#10004";}  ?> </td>
      <td> <?php if($meeting_state[7]==1 && $meeting[7]==8){ echo "&#10004";}  ?> </td>
