...
<body>
  ...
  <div class="slider_area" style="padding-left:1%">
    <div class="single_slider  d-flex align-items-center " style="  background-image: url(image_footer/2.png);   background-size:auto;   background-position:top ; height:300px;">
      <div class="row text-right" style="margin-left:65%; margin-top:150px;">
        <div class="col-12 text-right">
          <div class="section_title text-right mb-55" >
          <h3 dir="rtl" style="font-size:30px"><span>   متابعة طالبات الدروس الاسلامية  </span></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="popular_causes_area pt-120" dir="rtl">
    <div class="container">
      ...
      $sql = "SELECT lessonName, Day ,IslamicVolunteerID, bookName, meetingsNumber, time	  FROM islamicvolunteer WHERE FacultyUniversityID = $faculty_Id AND requestState='مقبول'";
        ...
        if (mysqli_num_rows($result) > 0)  {
            ...
            while($row = mysqli_fetch_assoc($result)) {
              ...
              $meetingsNumber = $row["meetingsNumber"];
               $time = $row["time"];
               $_SESSION['islamicID'] =  $row["IslamicVolunteerID"];
    ...
    <div class="single_cause">
      <div class="causes_content text-center">
        ...
        <div class="balance d-flex justify-content-between align-items-center text-center">
          <h3 class="text-center" style=" margin-left: auto; margin-right: auto;"><?php echo $lessonName; ?></h3>
        </div>

        <p dir="rtl" > <?php echo "اسم الكتاب  : $bookName"?></p>
        <p dir="rtl" ><?php echo "عدد اللقاءات  : $meetingsNumber"?></p>
        <p dir="rtl" ><i class="fa fa-calendar"></i><?php echo "  $Day"?></p>
         <p dir="rtl" ><i class="fa fa-clock-o"></i><?php echo " $time"?></p>

        <?PHP $ISLAMICID =  $_SESSION['islamicID']; ?>

         <a class="genric-btn success radius" href="<?php echo "attendance schedule volunteer.php?ISLAMIC_ID=$ISLAMICID "; ?>" style="margin-top:-1px;">فـتح</a>
         <a class="genric-btn success radius" href="<?php echo "Fill Certificate content.php?ISLAMIC_ID=$ISLAMICID"; ?>" style="margin-top:-1px;">تعبئة محتوى الشهادة</a>
