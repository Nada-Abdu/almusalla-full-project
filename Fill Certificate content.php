...
<body>
  ...
  <?php     session_start();
   ...
   include "Asrar-files/config.php";
     ...
     $IslamicVolunteerID ;
     $_SESSION["islamic_ID"] = (int)$_GET['ISLAMIC_ID']; ;
  ...
  //  $_SESSION["IslamicVolunteerID"] = 3; // delete it , should be their before from start
    ...
    $query = "UPDATE `IslamicVolunteer` SET  `CertificateName`='$name' , `havingCertificate` = '1'  where `IslamicVolunteerID`=$islamicID";
      ...
      <div class="row">
        <div class="col-12 grey-box">
          ...
          ?>
            ...
            <p id="save-p" style="display:none;"> <?php echo "Fill Certificate content.php?ISLAMIC_ID=$sss"; ?> </p>
  ...
  <script>
    function sendCertificate() {
      var href=document.getElementById('save-p').innerHTML;
      var canvas = document.querySelector('#canvas');
      var canvasData = canvas.toDataURL("image/png");
      //'Fill Certificate content.php'
      $.ajax({
        url:href,
        type: 'post',
        data: {
