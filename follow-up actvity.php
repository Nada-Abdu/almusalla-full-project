...
<li><a style="font-size:15px;">|</a></li>
  ...
  <div class="slider_area" style= "padding-left:1%">
    <div class="single_slider  d-flex align-items-center   " style="  background-image: url(image_personal_page/1.png);   background-size:auto;   background-position:top ;">
      ...
      <div class="row text-right" style="margin-left:73%; margin-top:-23%;">
              <div class="col-12 text-right">
                <div class="section_title text-right mb-55">
                  <h3 dir="rtl" style="font-size:30px"><span>جدول متابعة النشاط</span></h3>
                </div>
              </div>
            </div>
...
<div style="  margin-top:-23%;padding:5%" >
  ...
  <div  id = student_info data-scroll-index='1' class="make_donation_area section_padding">
                        ...
                        <div class="single_amount">
                           <div class="fixed_donat">
                               <div class="select_prise"  style="padding:1%; padding-right:4% "  >
                                ...
                                $infoActvties= mysqli_query($connect,"SELECT * FROM `activities` WHERE `activityid`='$activity'"); // activityid from session or from click
                                   ...
                                   ?>
                <?php
                 $studentname= mysqli_query($connect,"SELECT * FROM `student` WHERE `university_ID`='$studentid'");
...
?>
                                     ...
                                     <h4 dir="rtl" >رقم المقــــــرر :<label dir="rtl" style="width:40%; padding-right:1.2% "  > <?php echo $courseid ?> </label></h4>
                                         ...
                                         <h4 dir="rtl" > رقم الشعبـــــة :   <label dir="rtl"  style="width:40%;padding-right:1.2% "  > <?php echo $groupnum ?>  </label></h4>
                                            ...
                                            <div class="col-3">
                                           <h4 dir="rtl"  >   الرقم الجامعي :   <label dir="rtl" style="width:40%; padding-right:1.2%" >  <?php echo $studentid ?>   </label></h4> <!-- from session-->
                                               </div>
                                         <div class="col-3">
                                          <h4 dir="rtl">  اسم الطالبـــــة :   <label dir="rtl" style="width:40%;padding-right:1.2%" ><?php echo $name; ?> </label></h4>
                                            ...
                                            <div class="row"style="padding-top:2%;">
                                                 ...
                                                 <div class="col-3">
                                                <h4 dir="rtl" > درجة التحسين : <label dir="rtl" style="width:40%; padding-right:1.2% "  > <?php echo $bonus  ?></label></h4>
                                                    </div>
                                                    <div class="col-3">
...
<div>
 ...
 <div  style="padding-left:7% ; padding-right:7% ; margin-top:-9% ; padding-bottom:15%">
  ...
  <th style=" background-color: #07b5b2">ملاحظات</th>
    ...
    <tr>
      <?php
      $infoStudents= mysqli_query($connect,"SELECT * FROM `followupactivity` WHERE `activity_id`='$activity'  AND	`student_id`='$studentid'");
