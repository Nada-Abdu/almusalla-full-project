      ...
      <div id="sticky-header" class="main-header-area" style="margin-top: 15px;">
        <div class="container-fluid">
          <div class="row align-items-center">
            ...
            <!-- faculty member  -->
            <div class="col-xl-10 col-lg-10" style="padding-right:10%">
              <div class="main-menu">
                <nav>
                  <ul id="navigation">
                     <div class="dropdown" >
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
       ...
       $connect = mysqli_connect('localhost','root','05371433','almusalla');
        ...
        $sql = "SELECT coursename, courseid, groupnum, activityname , activitytype, bonus, attendancenum FROM activities WHERE facumemid = $facumemid ";
        ...
        <p dir="rtl" ><?php echo "درجة التحسين : $bonus"?></p>
         <?php
            if ($activitytype ==  "نشاط حلقات القران الكريم"){
             $link = "students follow-up.php";
            }
            if ($activitytype ==  "نشاط الدروس الإسلامية"){
            $link ="‏‏students attendance.php";
