          ...
          <div id="myModal" class="modal" style=" z-index:1000;">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" >
                ...
                <form action="Personal Page for Faculty Member.php?reason2=saveinfo" method="post"  style="text-align:center">

                  <input type="text" id="facultyPhoneNum" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                   name="facultyPhoneNum" placeholder="<?php echo $_SESSION['facultypn']; ?>" maxlength="10">
                  <input type="text" id="facultyDep" name="facultyDep" placeholder="<?php echo $_SESSION['facultydep']; ?>">
                  <input type="password" id="facultypass" name="facultypass" placeholder="كلمة المرور">
                  ...
                  <div class="single_reson">
                    <div class="thum" >
                      <div class="row" style="margin-left:-90%;">
                        <div class="col-5">
                      <h3  style="font-size:30px"><span style="margin-top:115%; margin-right:-9%;"><?php  echo " مرحبــاً"; echo "  "; echo $_SESSION['facultyname']; ?></span></h3>
                         </div>
...
<div class=" col-3 rec2" > معلــومــــاتي الشخصيــــة </div>
  ...
  <div class="row"  style="padding-top:5%; padding-left:12%;">
    <div class="col-2" style="width:290px;  ">
      <label class="rec3" style="background-color:#ffffff; width:285px;font-size:14px;padding-right:18%;color:black" > <?php  echo $_SESSION['facultyemail'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    </div>
...
<div class="col-2" style="width:270px;" >
  <label class="rec3" style="background-color:#ffffff; width:250px;font-size:14px;padding-right:18%;color:black" ><?php  echo $_SESSION['facultyid'];?>&nbsp;</label>
</div>
<div class="col-2" >
<h4 class="rec3" style=" width:100px;   background-color:#F7F7F7;"> رقــم المنســـوب&nbsp;</h4>
</div>
<div class="col-2" style="width:270px;  ">
  <label class="rec3" style="background-color:#ffffff; width:250px;;font-size:14px;padding-right:18%;color:black " ><?php  echo $_SESSION['facultyname'];?> &nbsp;</label>
</div>
...
<div class="row" style="padding-top:4%; padding-left:12%;">
  <div class="col-2" style="width:270px;  ">
  </div>
...
<div class="col-2" style="width:270px;" >
<label class="rec3" style="background-color:#ffffff; width:250px;;font-size:14px;padding-right:18%;color:black" ><?php  echo $_SESSION['facultypn'];?>  &nbsp;</label>
</div>
<div class="col-2" >
<h4 class="rec3" style=" width:100px;   background-color:#F7F7F7;">رقم الجوال&nbsp;</h4>
</div>
<div class="col-2" style="width:270px;  ">
<label class="rec3" style="background-color:#ffffff; width:250px;font-size:14px;padding-right:40%;color:black " > <?php  echo $_SESSION['facultydep'];?>&nbsp;</label>
</div>

<div class="col-2"  >
<h4 class="rec3" style=" width:100px;   background-color:#F7F7F7; ">الكلية - القسم&nbsp;</h4>
</div>
...
<div class="row " >
  <div class=" col-3"> </div>
  <div class=" col-3 "> </div>
<div class=" col-3" style="padding-left:270px; z-index:1; margin-top:80px"> </div>
<div class=" col-3 rec2" style="font-size:25px; text-align:right; ">  التنبيـــهات </div>
</div>


<div class="rec3" style="height:300px; width:1070px; background-color:#ffffff;   margin-top:1%; margin-left:10%;">
  ...
  <?php
    ...
    echo   $nameofsu." - ";
    if($row['requestState'] == "انتظار"){
    echo " الطلب تحت المعالجة الرجاء الانتظار "."<br />";
  }
    else if ($row['requestState'] == "مقبول"){
      echo " تم قبول الطلب"."<br />";
  }else {
    echo " الطلب ";
    echo $row['requestState']." ";
    echo "(لتعديل الطلب الرجاء الضغط <a href='requesting form as Quran volunteer.php?reason=editform'>هنا</a> )";
  }
}
  }
  ?>
  ...
  <?php
    $ID = $_SESSION['facultyid'];
    $result = $connect->query("SELECT * FROM `islamicvolunteer` WHERE FacultyUniversityID=$ID ");
    ...
    $reqs = $row['IslamicVolunteerID'];
    echo " الطلب ";
    echo $row['requestState']." ";
    echo "(لتعديل الطلب الرجاء الضغط <a href='requesting form as Islamic volunteer.php?reason5=editform$reqs'>هنا</a> )"."<br />";
  }
}
  }
  ?>
...
if(Empty($_POST["facultyPhoneNum"])){
$phonenumber=$_SESSION['facultypn'];
}
else if(!Empty($_POST["facultyPhoneNum"])){
$phonenumber= $_POST["facultyPhoneNum"];
}
if(Empty($_POST["facultyDep"])){
$depart=$_SESSION['facultydep'];
}
else if(!Empty($_POST["facultyDep"])){
$depart= $_POST["facultyDep"];
}
if(Empty($_POST["facultypass"])){
$password=  $_SESSION['facultypw'];
}
else if(!Empty($_POST["facultypass"])){
$password=$_POST["facultypass"];
}

 $ID=$_SESSION['facultyid'];

 $connect->query("UPDATE `facultymember` SET PhoneNumber = $phonenumber,FacultyDepartment='$depart',Password=$password WHERE FacultyUniversityID=$ID");


 $_SESSION['facultypn'] =$phonenumber;
 $_SESSION['facultydep'] = $depart;
