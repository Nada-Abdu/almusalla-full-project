                          ...
                          <div style="  text-align: right;  margin-top:-10% ; padding-right:-33.9%" >
                              <div class="single_amount">
                                 <div class="fixed_donat">
                                   <div class="row">
                                        <div class="col-3">
                                       <h4 dir="rtl" > نوع النشاط :<label dir="rtl" style="width:40%; padding-right:1.2% "  > <?php echo $row['activitytype'];?> </label></h4>
                                           </div>
                                           <div class="col-3">
...
$LessonID = $_GET['IslamicVolunteerID'];
...
$sql = "SELECT * FROM attendance WHERE student_ID=$student_id  AND IslamicVolunteerID = $LessonID And activityid= $Activity_ID";
